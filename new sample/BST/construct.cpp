...
binarytree<int>*construct(int arr[],int startindex,int endindex)
{
    ...
    binarytree<int>*root=new binarytree<int>(rootdata);
    binarytree<int>*rootleft=construct(arr,startindex,mid-1);
    binarytree<int>*rootright=construct(arr,mid+1,endindex);
    root->left=rootleft;
...
int main()
{
    ...
    binarytree<int>*root=construct(arr,0,6);
    print(root);
}